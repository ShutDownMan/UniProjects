...
QT_MOC_LITERAL(3, 32, 24) // "on_pb_findOficio_clicked"

    },
    "Cadastro\0on_pushButton_clicked\0\0"
    "on_pb_findOficio_clicked"
};
...
void Cadastro::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_pb_findOficio_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Cadastro::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Cadastro.data,
      qt_meta_data_Cadastro,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Cadastro::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Cadastro.stringdata0))
        return static_cast<void*>(const_cast< Cadastro*>(this));
